...
####USER DEFINED
stitch_searchstring<-"*JJA_SP*stats.txt"
nostitch_searchstring<-"*JJA_SP*stats_nostitch.txt"
netcdf_searchstring_model<-"JJA_SP*blobs.nc"
netcdf_searchstring_rean<-"*JJA*blobs.nc"

input_directory<-"~/BLOBSTATS_FILES"
stitchlist_fnames<-sprintf("%s/%s/%s_stitch_list_JJA_SP",input_directory,Varnames,Varnames)
