...
rfn_ps=sprintf("%s/%s_%s_ic_ERA_CFSR.RData",output_dir,SEASON,SECTOR)
txt_overlaps=sprintf("%s/%s_%s_ic_ERA_CFSR_table.txt",output_dir,SEASON,SECTOR)
txt_ps=sprintf("%s/%s_%s_ic_ERA_CFSR_probsim.txt",output_dir,SEASON,SECTOR)
